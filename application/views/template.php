	...
	<div class="wrapper">
		<header class="main-header">
			<a href="<?= base_url('dashboard') ?>" class="logo">
				<span class="logo-lg">Lava<b>RESTO</b></span>
			</a>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview <?= $this->uri->segment(1) == 'stock' || $this->uri->segment(1) == 'sale' || $this->uri->segment(1) == 'payment' ? 'active' : '' ?>">
						<a href="#">
						...
						<ul class="treeview-menu">
							...
							<li <?= $this->uri->segment(1) == 'payment' ? 'class="active"' : '' ?>>
								<a href="<?= site_url('payment') ?>"><i class="fa fa-circle-o"></i>Payment Status</a>
							</li>
					...
					<li <?= $this->uri->segment(1) == 'sale' ? 'class="active"' : '' ?>>
						<a href="<?= site_url('report/sale') ?>"><i class="fa fa-pie-chart"></i> <span>Sales</span></a>
					</li>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2021 Lava Resto</a>.</strong> All rights reserved.
		</footer>
